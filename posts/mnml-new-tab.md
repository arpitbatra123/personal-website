...
If you've seen my blog post titled [inspo](/posts/inspo), you already know how impressed I am [torvim's](https://torvim.github.io/) [inspo](https://u.teknik.io/E32bU.zip) collection.

One day, as I was randomly browsing images in this collection, I came across the following image:
...
I had been using other extensions to show bookmarks from my bookmarks toolbar in the new tab page so that they could be easily accessible. So upon seeing the screenshot from the inspo collection, I decided to create a browser extension that looks exactly like it. There might already be an extension with the exact design ( how else would that screenshot exist then?), but earning an extension that I will use daily seemed fun so I went through with it.
